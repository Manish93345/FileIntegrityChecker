...
class ProIntegrityGUI:
    ...
    def _setup_tray_icon(self):
        ...
        try:
            # --- FIX: Correct path based on your installation structure ---
            # 1. Try PyInstaller internal path
            ...
            # 3. Fallback: Check if it's in an 'icons' subdirectory just in case
    ...
    def _check_safe_mode_status(self):
        ...
        try:
            ...
            if not is_safe:
                # Fallback check internal memory
                if safe_mode:
